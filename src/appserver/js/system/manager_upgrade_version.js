...
//		warBoxM,
        ...
        {header:"版本发布时间",dataIndex:"buildDate",align:'center'},
        {header:"当前版本号",dataIndex:"warVersion",align:'center',width:50},
        {header:"上传版本号",dataIndex:"newVersion",align:'center'},
        {header:"升级包",dataIndex:"newVersion",align:'center',width:50,renderer:show_newVersion},
        {header:"上传时间",dataIndex:"upgradeTime",align:'center'},
        {header:"操作标记",dataIndex:"flag",align:'center',width:50,renderer:show_flag}
    ]);
...
function show_newVersion(value) {
    if(value=='没有上传升级版本') {
        return '<h1 style="color: gray;">不存在</h1>';
    } else {
        return '<h1 style="color: green;">存在</h1>'
    }
}
