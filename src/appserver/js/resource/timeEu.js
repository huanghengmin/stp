...
Ext.DateTimePicker = Ext.extend(Ext.DatePicker, {
    ...
    onRender: function(container,position){
        ...
        var tfEl = Ext.DomHelper.insertBefore(table.last(),{tag:'tr',children:[{tag:'td',cls:'x-date-bottom',html:this.timeLabel,style:'width:30;'},{tag:'td',cls:'x-date-bottom ux-timefield tx', colspan:'2'}]},true);
        try{
