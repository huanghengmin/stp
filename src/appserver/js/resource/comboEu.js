...
//        + '}</div>'
//    ;
    this.tpl = config.tpl || '<tpl for="."><div class="x-combo-list-item"><table><tbody><tr>' +
                '<td><div><img class="{'+ this.iconClsField + '}" src="../../js/ext/resources/images/default/s.gif"/></div></td>' +
