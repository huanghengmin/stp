...
function SoundManager(smURL,smID) {
  ...
  this.debugMode = true;           // enable debugging output (div#soundmanager-debug, OR com.inetec.ichange.console if available + configured)
  this.useConsole = true;          // use firebug/safari com.inetec.ichange.console.log()-type debug com.inetec.ichange.console if available
  this.consoleOnly = false;        // if com.inetec.ichange.console is being used, do not create/write to #soundmanager-debug
  ...
  /*global SM2_DEFER, sm2Debugger, alert, com.inetec.ichange.console, document, navigator, setTimeout, window */
  ...
  this._complain = function(sMsg,oCaller) {
	...
	// See JS error/debug/com.inetec.ichange.console output for real error source, stack trace / message detail where possible.
  ...
  this._createMovie = function(smID,smURL) {
    ...
    oD.title = 'Toggle SM2 debug com.inetec.ichange.console';
  ...
  this.load = function(oOptions) {
    if (typeof oOptions != 'undefined') {
      ...
      // com.inetec.ichange.console.log('typeof oOptions: '+(typeof oOptions)+', lastURL: '+_t._lastURL+', _t.url: '+_t.url);
