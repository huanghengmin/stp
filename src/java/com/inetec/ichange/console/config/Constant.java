...
public class Constant {
    ...
    public final static String S_INTERNAL_PATH = System.getProperty("ichange.home") + "/repository/config.xml";
    public final static String S_EXTERNAL_PATH = System.getProperty("ichange.home") + "/repository/external/config.xml";
